    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-1 p-1 bg-slate-100 dark:bg-slate-900 rounded-2xl w-fit border border-slate-200 dark:border-slate-800">
        <button
          ...
          className={`flex items-center gap-1.5 px-4 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer ${activeTab === "PAYROLL"
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-4 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer ${activeTab === "ADVANCES"
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-4 py-1.5 rounded-xl text-xs font-bold transition cursor-pointer ${activeTab === "HISTORY"
              ...
              <div className="flex gap-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
                {["ALL", "ACTIVE", "PAID_OFF"].map((st) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg text-xs font-bold transition cursor-pointer ${advanceFilterStatus === st
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap justify-between md:justify-end">
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition flex items-center gap-1.5 cursor-pointer border ${(data as any).isPeriodLocked
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-left transition cursor-pointer ${newAdvanceScheme === "FULL"
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-left transition cursor-pointer ${newAdvanceScheme === "INSTALLMENT"
